...
class FrameSequencePayload(tf.keras.utils.Sequence):
    ...
    def __init__(self, root: str, *, frame_size=160, frames_per_payload=15,
                 payload_bits=64, batch=32, fs=16_000, shuffle=True):
        self.F  = frame_size
    ...
    def __getitem__(self,i):
        ...
        for fi,st in segs:
            ...
            # bits
            bits = np.random.randint(0,2,(self.P,),dtype=np.uint8) #generate new payload per batch (1 batch = 1 window)
